...
local wowversion, wowbuild, wowbuilddate, tocversion = GetBuildInfo()
...
if gameLocale == "frFR" then
  ...
  L["Add stat"] = "Ajouter Statistique" -- Needs review
  L["Advanced mode"] = "Mode Avancee" -- Needs review
  L["All Stats"] = "Toutes les stats"
  L["At least"] = "Au moins"
  L["At most"] = "Au plus"
  L["Avoidance"] = "Evitement" -- Needs review
  L["Bear"] = "Ours"
  ...
  L["Move up"] = "Monter la Stat" -- Needs review
  L["None"] = "Aucun"
  ...
  L["ParryLong"] = "Parade"
--   L["Pawn scales"] = ""
  L["Please press Compute button to update the reforge."] = "S'il vous plait appuyez sur le bouton Calculer pour mettre à jour la reforge." -- Needs review
  L["Presets"] = "Pré-établis"
  L["PvP (+0)"] = "JcJ (+0)" -- Needs review
  L["PvP (496)"] = "JcJ (ilvl 496)" -- Needs review
  L["Raids (+3)"] = "Raids (+3)" -- Needs review
  ...
  L["Spirit to hit and expertise"] = "Toucher par l'esprit et de l'expertise" -- Needs review
...
elseif gameLocale == "deDE" then
  ...
  L["Only one cap allowed with spirit-to-hit conversion"] = "Nur ein Höchstwert ist erlaubt bei der Willenskraft nach Trefferwertung umwandlung"
...
elseif gameLocale == "itIT" then
  ...
  L["Block chance"] = "Probabilità Di Blocco"
  L["Cancel"] = "Cancella"
  L["Cap value"] = "Valore Cap"
  L["Cat"] = "Gatto"
  L["Clear"] = "Pulisci"
  L["Click an item to lock it"] = "Premi un oggetto per bloccarlo"
  L["Compute"] = "Calcola"
  L["Control"] = "Controllo"
  L["Crit"] = "Critico"
  ...
  L["Delete"] = "Cancella"
  L["Dodge"] = "Schivata"
  L["Dodge chance"] = "Probabilità Di Schivata"
  ...
  L["Item level cap"] = "Cap Livello oggetto"
  L["Manual"] = "Manuale"
  L["Mastery"] = "Maestria"
  L["MasteryLong"] = "Maestria"
  ...
  L["Parry"] = "Parata"
  L["Parry chance"] = "Probabilità Parata"
  L["ParryLong"] = "Parata"
  ...
  L["ReforgeLite failed to compute your optimal reforge. Try increasing the speed by moving the speed slider.\\nError message: %s"] = "ReforgeLite ha fallito nel computare un riforgiamento ottimale. Prova ad incrementare la velocità spostando lo scorrevole. \\n Messaggio di errore: %s"
  ...
  L["Strength/Agility"] = "Forza/Agilità"
  L["Sum"] = "Somma"
