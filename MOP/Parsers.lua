...
local InputFrame = CreateFrame ("Frame", "ReforgeLiteInputFrame", UIParent, "BackdropTemplate")
InputFrame:Hide()
...
InputFrame.text = CreateFrame ("EditBox", "ReforgeLiteInputFrameText", InputFrame.scroll, "BackdropTemplate")
