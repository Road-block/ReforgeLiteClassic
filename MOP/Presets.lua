...
function ReforgeLite:InitPresets ()
  ...
  self.presetMenu = CreateFrame ("Frame", "ReforgeLitePresetMenu", nil, "BackdropTemplate")
  ...
  self.methodPresetMenu = CreateFrame ("Frame", "ReforgeLiteMethodPresetMenu", nil, "BackdropTemplate")
  ...
  self.presetDelMenu = CreateFrame ("Frame", "ReforgeLitePresetDelMenu", nil, "BackdropTemplate")
  ...
  self.methodPresetDelMenu = CreateFrame ("Frame", "ReforgeLiteMethodPresetDelMenu", nil, "BackdropTemplate")
  ...
  self.methodImportMenu = CreateFrame("Frame", "ReforgeLiteMethodImportMenu", nil, "BackdropTemplate")
