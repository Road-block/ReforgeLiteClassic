...
function ReforgeLite:CreateTaskUI()
  ...
  self.targetLevel.tip = CreateFrame("Frame", nil, self.content, "BackdropTemplate")
  ...
  local ilvlCapList = {{value = 0, name = L["None"]}, {value = 550, name = L["PvP (550)"]}}
  ...
  self.ilvlCap.tip = CreateFrame("Frame", nil, self.content, "BackdropTemplate")
